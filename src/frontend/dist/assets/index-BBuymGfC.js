...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-3xl border border-border bg-card/80 p-5 shadow-teal backdrop-blur transition-all duration-300 hover:shadow-teal-lg hover:border-primary/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-display text-3xl font-semibold text-foreground", children: value }),
    note ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-emerald-400", children: note }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "mt-3 h-0.5 w-full rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100",
        style: {
          background: "linear-gradient(90deg, oklch(0.72 0.18 195), oklch(0.78 0.22 195 / 0))"
        }
      }
    )
  ] });
...
function SectionTitle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    eyebrow ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold uppercase tracking-[0.2em] text-primary/80", children: eyebrow }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 font-display text-3xl font-bold text-foreground", children: title }),
    subtitle ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-muted-foreground", children: subtitle }) : null
  ] });
}
function GoGrabXFleetTracking() {
  const [page, setPage] = reactExports.useState("login");
  const [selectedBikeId, setSelectedBikeId] = reactExports.useState("GGRX-024");
  ...
  const notifications = [
    ...
    },
    {
      ...
      detail: "Bhimavaram deployment page is now open for investor reservations.",
      type: "Expansion"
    }
  ];
  const statCards = [
  ...
  const selectedBike = reactExports.useMemo(
    () => bikes.find((bike) => bike.id === selectedBikeId) ?? bikes[0],
    [selectedBikeId]
  );
  const linePoints = [38, 46, 42, 58, 63, 61, 76, 72, 84, 92];
  const linePath = linePoints.map(
    (value, index2) => `${index2 === 0 ? "M" : "L"} ${index2 * 32 + 6},${110 - value}`
  ).join(" ");
  const openBike = (bikeId) => {
  ...
  const SideNav = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: isDark ? "linear-gradient(160deg, oklch(0.12 0.018 240 / 0.95) 0%, oklch(0.1 0.012 260 / 0.98) 100%)" : "linear-gradient(160deg, oklch(0.99 0.006 240 / 0.97) 0%, oklch(0.97 0.008 220 / 0.99) 100%)",
          boxShadow: isDark ? "0 0 0 1px oklch(0.72 0.18 195 / 0.12), 0 24px 60px oklch(0.04 0.01 260 / 0.8)" : "0 0 0 1px oklch(0.48 0.18 195 / 0.15), 0 24px 60px oklch(0.48 0.18 195 / 0.06)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 px-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-[0.3em] text-primary/70", children: "GoGrabX" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 font-display text-lg font-bold text-foreground", children: "Investor OS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "mt-2 h-px w-full rounded-full",
                style: {
                  background: "linear-gradient(90deg, oklch(0.72 0.18 195 / 0.5), transparent)"
                }
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: items.map(([label, target], i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              "data-ocid": `sidenav.link.${i + 1}`,
              onClick: () => setPage(target),
              className: `w-full rounded-2xl px-4 py-3 text-left text-sm font-medium transition-all duration-200 ${page === target ? "text-primary-foreground shadow-teal" : "text-muted-foreground hover:text-foreground"}`,
              style: {
                background: page === target ? "linear-gradient(135deg, oklch(0.72 0.18 195), oklch(0.65 0.2 195))" : "transparent",
                boxShadow: page === target ? "0 0 20px oklch(0.72 0.18 195 / 0.25)" : void 0
              },
              onMouseEnter: (e) => {
                if (page !== target) {
                  e.currentTarget.style.background = isDark ? "oklch(0.15 0.015 260 / 0.8)" : "oklch(0.92 0.012 240 / 0.8)";
                }
              },
              onMouseLeave: (e) => {
                if (page !== target) {
  ...
  const AppShell = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              backgroundImage: "radial-gradient(circle, oklch(0.72 0.18 195 / 0.35) 1px, transparent 1px)",
              backgroundSize: "32px 32px"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 py-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: isDark ? "oklch(0.13 0.015 260 / 0.8)" : "oklch(0.95 0.01 240 / 0.9)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pulse-dot h-2 w-2 rounded-full bg-emerald-400" }),
                    "Live Fleet Intelligence + Investor Portfolio"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-3 font-display text-4xl font-bold tracking-tight text-foreground md:text-5xl", children: [
                "GoGrabX",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.72 0.18 195), oklch(0.65 0.18 55))",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent"
                    },
                    children: "Investor Platform"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-2xl text-sm text-muted-foreground md:text-base", children: "A founder-demo investor operating system for EV bike ownership, payouts, co-ownership, maintenance, and expansion." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: isDark ? "linear-gradient(135deg, oklch(0.12 0.018 220 / 0.9), oklch(0.1 0.01 260 / 0.95))" : "linear-gradient(135deg, oklch(0.97 0.01 220 / 0.95), oklch(0.99 0.006 240 / 0.98))"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-[0.25em] text-primary/70", children: "Investor Login" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 font-display text-2xl font-bold text-emerald-400", children: "Ravi Kumar Family" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-muted-foreground", children: "Tanuku • West Godavari • Synced every 5 sec" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isDark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 18, className: "text-secondary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 18, className: "text-primary" })
              }
            )
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-12 border-t border-border pt-6 text-center text-xs text-muted-foreground", children: [
            "© ",
  ...
  const renderLogin = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "radial-gradient(circle, oklch(0.72 0.18 195 / 0.4) 1px, transparent 1px)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: isDark ? "linear-gradient(145deg, oklch(0.12 0.02 240 / 0.95) 0%, oklch(0.1 0.012 265 / 0.98) 100%)" : "linear-gradient(145deg, oklch(0.99 0.005 240 / 0.97) 0%, oklch(0.97 0.008 220 / 0.99) 100%)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-sm font-bold uppercase tracking-[0.3em] text-primary/80", children: "GoGrabX" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-3 font-display text-4xl font-bold text-foreground", children: "Welcome back" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-8 text-sm text-muted-foreground", children: "Track your EV bike assets, earnings, GPS movement, and ownership certificates in one premium portal." }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.72 0.18 195), oklch(0.65 0.2 185))"
                    },
                    children: "Login to Portfolio"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-xs text-muted-foreground", children: "Demo credentials pre-loaded for founder pitch" })
              ] })
            ]
          }
        )
  ...
  const cardStyle = {
    background: isDark ? "linear-gradient(135deg, oklch(0.12 0.018 240 / 0.9) 0%, oklch(0.1 0.012 260 / 0.95) 100%)" : "linear-gradient(135deg, oklch(0.99 0.005 240 / 0.95) 0%, oklch(0.97 0.008 220 / 0.98) 100%)"
  };
  const renderCertificate = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "rounded-[2rem] border border-border p-10 shadow-teal backdrop-blur",
      style: cardStyle,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold uppercase tracking-[0.2em] text-primary/80", children: "GoGrabX Technologies Private Limited" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-6 mt-3 font-display text-3xl font-bold", children: "Bike Ownership Certificate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-6 text-muted-foreground", children: "This certificate confirms Ravi Kumar Family owns a fractional share in the GoGrabX EV bike listed below." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2", children: [
          ...
          "div",
          {
            ...
            style: {
              background: isDark ? "oklch(0.09 0.01 260 / 0.8)" : "oklch(0.94 0.008 240 / 0.9)"
            },
            children: [
  ...
  const renderPayouts = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: isDark ? "oklch(0.12 0.015 170 / 0.5)" : "oklch(0.95 0.012 170 / 0.6)"
          },
          children: "Last payout synced 5 min ago"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: cardStyle,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", "data-ocid": "payouts.table", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              style: {
                background: isDark ? "oklch(0.09 0.012 260 / 0.9)" : "oklch(0.92 0.012 240 / 0.9)",
                color: "oklch(0.72 0.18 195)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-xs font-bold uppercase tracking-wider", children: "Date" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-xs font-bold uppercase tracking-wider", children: "Bike" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-xs font-bold uppercase tracking-wider", children: "Gross Revenue" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-xs font-bold uppercase tracking-wider", children: "Investor Share" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4 text-xs font-bold uppercase tracking-wider", children: "Status" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: payouts.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              "data-ocid": `payouts.row.${i + 1}`,
              className: "border-t border-border transition-colors hover:bg-primary/5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-sm text-muted-foreground", children: row.date }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-sm font-semibold text-foreground", children: row.bike }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-sm text-foreground", children: row.gross }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-sm font-semibold text-emerald-400", children: row.investorShare }),
  ...
  const renderBike = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 md:flex-row md:items-center md:justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: isDark ? "oklch(0.12 0.015 250 / 0.6)" : "oklch(0.94 0.01 240 / 0.7)"
          },
          children: [
            selectedBike.city,
            " •",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: selectedBike.status })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2 xl:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Distance Today", value: selectedBike.km }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Revenue Today", value: selectedBike.earnings }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Battery", value: `${selectedBike.battery}%` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Speed", value: `${selectedBike.speed} km/h` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 xl:grid-cols-[1.3fr_.7fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: "ROI Trend" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 320 120", className: "w-full", "aria-hidden": "true", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "lineGrad", x1: "0", y1: "0", x2: "1", y2: "0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.72 0.18 195)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.78 0.22 195)" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "path",
                      {
                    ...
                    linePoints.map((value, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "circle",
                      {
                        cx: index2 * 32 + 6,
                        cy: 110 - value,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-5 gap-2 text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Week 1" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Week 2" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Week 3" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Week 4" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Month End" })
                  ] })
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: cardStyle,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: "Asset Verification" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 space-y-3 text-sm", children: [
              ["Bike ID", selectedBike.id],
              ["Legal No", selectedBike.legal],
              ...
              "div",
              {
                ...
                style: {
                  background: isDark ? "oklch(0.09 0.01 260 / 0.7)" : "oklch(0.94 0.008 240 / 0.8)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                    k,
  ...
  const renderInvest = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionTitle,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 xl:grid-cols-[1.1fr_.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-[2rem] border border-border p-6 shadow-teal backdrop-blur",
          style: cardStyle,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold", children: "Bike Funding Structure" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 grid gap-4 md:grid-cols-2", children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-display text-lg font-bold text-foreground", children: v })
                ]
              },
              k
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: isDark ? "oklch(0.15 0.01 260)" : "oklch(0.88 0.02 240)"
                },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(90deg, oklch(0.72 0.18 195), oklch(0.65 0.18 55))"
                    }
                  }
                )
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm text-muted-foreground", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "3/5 slots filled" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-[2rem] border border-border p-6 shadow-teal backdrop-blur",
          style: {
            background: "linear-gradient(135deg, oklch(0.72 0.18 195 / 0.08) 0%, oklch(0.65 0.18 55 / 0.06) 100%)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold uppercase tracking-[0.2em] text-primary/80", children: "Investor CTA" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 font-display text-2xl font-bold text-foreground", children: "Reserve Your Bike Share" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Choose bike city" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Tanuku" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Bhimavaram" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Rajahmundry" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  const renderFamily = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionTitle,
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Share" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Amount" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Role" })
              ]
            }
          ),
          familyMembers.map((member, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground", children: member.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary", children: member.share }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: member.amount }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: member.role })
              ]
            },
            member.name
          ))
  ...
  const renderNotifications = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { eyebrow: "Alerts Center", title: "Notifications" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: notifications.map((note, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold text-foreground", children: note.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "rounded-full px-3 py-1 text-xs font-semibold",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: note.detail })
        ]
      },
      note.title
    )) })
  ] }) });
  const renderMaintenance = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { eyebrow: "Operations", title: "Maintenance Alerts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg font-bold text-foreground", children: item.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-muted-foreground", children: item.sub }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
  ...
  const renderExpansion = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionTitle,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-bold text-foreground", children: item.city }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm text-muted-foreground", children: item.detail }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
  ...
  const renderDashboard = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-4", children: statCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: card.label, value: card.value }, card.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 xl:grid-cols-[1.6fr_.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: cardStyle,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-2 py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold text-foreground", children: "Live City Map" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Animated route movement across delivery hotspots" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 text-xs", children: ["Food", "Grocery", "Parcel"].map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "rounded-full border border-border px-3 py-1 text-muted-foreground",
                  style: {
                    background: isDark ? "oklch(0.14 0.015 260 / 0.7)" : "oklch(0.93 0.01 240 / 0.8)"
                  },
                  children: tag
                },
                tag
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(180deg, oklch(0.07 0.008 260) 0%, oklch(0.09 0.012 250) 100%)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                  ...
                  ].map(({ label, pos, color }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  bikes.map((bike, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      "data-ocid": `dashboard.map_marker.${index2 + 1}`,
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            style: {
                              ...
                              background: isDark ? "oklch(0.08 0.01 260 / 0.95)" : "oklch(0.97 0.006 240 / 0.98)"
                            },
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: bike.id }),
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 grid grid-cols-2 gap-2 text-[11px] text-muted-foreground", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  "Investor:",
                                  " ",
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: bike.investor })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  "Owns:",
                                  " ",
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: bike.ownership })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  "Today:",
                                  " ",
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: bike.earnings })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  "Distance:",
                                  " ",
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: bike.km })
                                ] })
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: cardStyle,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Fleet Health" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Notifications" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 space-y-3", children: notifications.slice(0, 3).map((note, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-foreground", children: note.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: note.type })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: note.detail })
                  ]
                },
                note.title
              )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 xl:grid-cols-[1.2fr_.8fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-[2rem] border border-border p-5 shadow-teal backdrop-blur",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Investor Portfolio" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "A premium ownership view for every funded EV bike" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "2026 Design"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 grid gap-4 md:grid-cols-4", children: portfolioCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatCard,
              {
                label: card.label,
                value: card.value,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { color: "oklch(0.72 0.18 195)" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Bike ID" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Investor" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Ownership" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Invested" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Today" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Month" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Status" })
                      ]
                    }
                  ),
                  investorBikes.map((bike, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground", children: bike.id }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "text-xs",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: bike.investor }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: bike.ownership }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: bike.amount }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-emerald-400", children: bike.today }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground", children: bike.month }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: cardStyle,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Quick Actions" }),
              ...
              ].map(([label, target], i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    background: isDark ? "oklch(0.09 0.01 260 / 0.6)" : "oklch(0.94 0.008 240 / 0.7)"
                  },
                  children: label
                },
                label
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-[2rem] border border-border p-5 shadow-teal backdrop-blur",
            style: {
              background: "linear-gradient(135deg, oklch(0.72 0.18 195 / 0.1) 0%, oklch(0.65 0.18 55 / 0.08) 100%)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-[0.2em] text-primary/80", children: "Investor-Grade Feature" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 font-display text-2xl font-bold text-foreground", children: "Track, verify, and scale" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "From co-ownership and payouts to maintenance and city expansion, this interface shows how GoGrabX can become a real EV investment product." })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: isDark ? "oklch(0.1 0.01 260 / 0.7)" : "oklch(0.95 0.008 240 / 0.8)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-foreground", children: "Manual test checklist" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 grid gap-2 text-muted-foreground md:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "1. Login button opens dashboard." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "2. Sidebar switches between all pages without syntax errors." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "3. Clicking any bike on map opens bike detail page." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "4. Clicking any bike row in portfolio opens bike detail page." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "5. Notifications page renders all alerts." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "6. Invest, family, maintenance, and expansion pages render correctly." })
          ] })
        ]
      }
    )
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(InternetIdentityProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GoGrabXFleetTracking, {}) }) })
);
